...
export function AddPlatformCard({
  ...
  return (
    <Link
      ...
      data-testid={testId}
      className={cn(
        "kpi-card flex border border-line bg-card transition-[transform,box-shadow,background-color] duration-150 hover:bg-secondary",
        variant === "strip"
    ...
    >
      <span
        className={cn(
          "inline-flex items-center justify-center rounded-lg border border-line bg-foreground text-white",
