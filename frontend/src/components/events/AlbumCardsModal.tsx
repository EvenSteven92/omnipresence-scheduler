  ...
  return (
    ...
    >
      <div
        ...
        className="flex max-h-[min(90vh,720px)] w-full max-w-[640px] flex-col overflow-hidden rounded-lg border border-line bg-background "
      >
        <div className="relative shrink-0 border-b border-line px-5 py-5 pr-14">
          ...
          <button
            ...
            aria-label="Close"
            className="absolute right-4 top-4 rounded-lg border border-line bg-card p-1.5 text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground"
          >
