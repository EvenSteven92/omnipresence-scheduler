...
export function EventPerformanceStrip({ perf }: { perf: EventPerformance }) {
  const cells = [
    { label: "Total views", value: fmtCompact(perf.totalViews), icon: Eye },
    { label: "Total likes", value: fmtCompact(perf.totalLikes), icon: Heart },
    { label: "Total shares", value: fmtCompact(perf.totalShares), icon: Share2 },
    {
