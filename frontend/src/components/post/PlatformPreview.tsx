...
export function PlatformPreview({
  ...
  const body = (
    <div className={variant === "panel" ? "" : "px-4 pb-4"}>
      {platforms.length === 0 ? (
        <div className="rounded-lg border border-line bg-paper-2 px-3 py-6 text-center text-body-sm text-muted-foreground">
    ...
    return (
      ...
      >
        <div className="flex items-center gap-2.5 border-b border-line px-3.5 py-2.5">
          <span className="flex h-7 w-7 items-center justify-center rounded-full border border-line bg-accent font-display text-[0.6875rem] font-bold text-foreground">
...
function PlatformMock({
  ...
  return (
    <div className="rounded-lg border border-line bg-paper-2 px-3 py-4 text-center text-body-sm text-muted-foreground">
      Preview for {network}
    </div>
  );
}
