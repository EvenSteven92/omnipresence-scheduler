  ...
  return (
    <aside data-testid="calendar-rail" className="page-grid-rail space-y-4">
      <section className="panel overflow-hidden">
        <header className="border-b border-foreground px-4 py-3">
      ...
      <section className="panel overflow-hidden">
        <button
          ...
          className="flex w-full items-center justify-between border-b border-foreground px-4 py-3 text-left"
        >
          <div>
              ...
              <>
                ...
                {monthPosts.slice(0, 8).map((post) => (
                  <button
                    ...
                    className="block w-full truncate rounded-sm border border-foreground px-3 py-2 text-left text-body-sm text-foreground hover:bg-secondary/30"
                  >
                    {post.title}
                  </button>
                ))}
