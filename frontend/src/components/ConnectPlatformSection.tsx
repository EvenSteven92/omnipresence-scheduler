...
export function ConnectPlatformSection({
  ...
  return (
    <section
      ...
      className="scroll-mt-8 rounded-lg border border-line bg-card shadow-[var(--shadow-card)]"
    >
            ...
            {availableCards.map((meta) => {
              ...
              return (
                <div
                  key={meta.short}
                  className={cn(
                    "flex flex-col gap-3 rounded-lg border border-line p-4",
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {comingSoonCards.map((meta) => (
                <div
                  key={meta.short}
                  data-testid={`connect-platform-${meta.short.replace(/\s+/g, "-")}`}
                  className="flex items-center gap-3 rounded-lg border border-line/40 bg-paper-2 px-4 py-4"
                >
    ...
    <div className="flex flex-wrap gap-2">
      {live.map((c) => {
        ...
        return (
          <div
            key={c.platform}
            className="inline-flex items-center gap-2 rounded-lg border border-line bg-success/10 px-3 py-2"
          >
      ...
      {demoPlatforms.slice(0, 4).map((p) => (
        <div
          key={p}
          className="inline-flex items-center gap-2 rounded-lg border border-line/40 bg-paper-2 px-3 py-2"
        >
